        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-information-sales" data-url-query="{{ route('ventas.folio',$venta) }}" data-bs-toggle="modal" data-bs-target="#InformacionModalProductos" title="ver detalles">
                            <span>&#128065;</span>
                        </button>
                    </td>
                </tr>
...
<script src="./js/reporteResumenes/resumenProductos.js"></script>
@endsection
    ...
    @slot('cuerpoModal')
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <x-input-normal class="col-md-12 col-sm-12" classesLabel="col-4" idInput="inputNombreProveedor" type="text" texto="Nombre(s) del Proveedor" valor="{{old('nombre')}}" nombreInput="nombre" nombreError="nombre" />
            ...
            <x-input-normal class="col-md-12 col-sm-12" classesLabel="col-4" idInput="inputNumExt" type="text" texto="Número Exterior" valor="{{old('numext')}}" nombreInput="numext" nombreError="numext" />
            <x-input-normal class="col-md-12 col-sm-12" classesLabel="col-4" idInput="inputNumInt" type="text" texto="Número Interior" valor="{{old('numint')}}" nombreInput="numint" nombreError="numint" />
            </div> 
            <div class="row">
    ...
    @slot('cuerpoModal')
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <x-input-normal class="col-md-12 col-sm-12" classesLabel="col-4" idInput="inputNombreProveedorEditar" type="text" texto="Nombre(s) del Proveedor" valor="{{old('nombreEditar')}}" nombreInput="nombreEditar" nombreError="nombreEditar" />
            ...
            <x-input-normal class="col-md-12 col-sm-12" classesLabel="col-4" idInput="inputNumExtEditar" type="text" texto="Número Exterior" valor="{{old('numextEditar')}}" nombreInput="numextEditar" nombreError="numextEditar"/>
            <x-input-normal class="col-md-12 col-sm-12" classesLabel="col-4" idInput="inputNumIntEditar" type="text" texto="Número Interior" valor="{{old('numintEditar')}}" nombreInput="numintEditar" nombreError="numintEditar"/>
            </div> 
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="input-group mb-3">

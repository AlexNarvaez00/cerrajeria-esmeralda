...
const createRowOfInformation = (title,information) =>{
    ...
    classOfComponentInformation.forEach(e=>componentInformation.classList.add(e));
    ...
    minAjax({
        ...
        modalBody.innerHTML = "";
            ...
            for (let index = 0; index < data.length; index++) {
                ...
                divNuevo.appendChild(createRowOfInformation('Nombre del producto:', informacionProdcutos.nombre_producto));    
                divNuevo.appendChild(createRowOfInformation('Cantidad:', informacionProdcutos.cantidad));    
                divNuevo.appendChild(createRowOfInformation('Cantidad en existencia:', informacionProdcutos.cantidad_existencia));    
                divNuevo.appendChild(createRowOfInformation('Clasificacion:', informacionProdcutos.clasificacion));        

    ...
    minAjax({
        ...
        modalBody.innerHTML = "";
            ...
            for (let index = 0; index < data.length; index++) {
                ...
                divNuevo.appendChild(createRowOfInformation('Id Servicio:', informacionProdcutos.idservicio));       
                divNuevo.appendChild(createRowOfInformation('Nombre producto:', informacionProdcutos.nombre_producto));    
                divNuevo.appendChild(createRowOfInformation('Precio del producto:', informacionProdcutos.precio_producto));        
                divNuevo.appendChild(createRowOfInformation('Precio de compra:', informacionProdcutos.precio_compra));        
